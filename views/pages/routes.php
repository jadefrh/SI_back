<div class="content">
  <div class="container">
    <div class="left panel pad">
      <div class="search">
        <h3 id="recherche">Itinéraire pour: Séances "Kung Fu Panda" autour de "Montreuil"</h3>
      </div>
      <div class="movie">
    ...
    <div class="right panel">
      <div class="map">
        ...
        &origin=Hetic+France&destination=Le%Melies%Montreuil+France&avoid=tolls|highways">
      </iframe>
    </div>
  </div>
</div>
