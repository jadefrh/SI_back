<div class="content">
  <div class="container">
    <div class="extra-panel">
      <div class="about">
        <h3>Politique de confidentialité de Twitter</h3>
        <p id="about">Nos Services relient instantanément les gens, où qu’ils soient, à ce qui compte le plus pour eux. Tout utilisateur enregistré auprès des Services Twitter peut envoyer un Tweet, qui est un message de 140 caractères maximum. Public par défaut, un Tweet peut inclure du contenu supplémentaire, tel que des photos, des vidéos et des liens vers d’autres sites.
          <br><br>
